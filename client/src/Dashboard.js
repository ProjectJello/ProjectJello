...
class Dashboard extends Component {
  constructor(props) {
    ...
    { 
      ...
      members: [{name: "Joe",  pfp: "../static/media/examplePfp.png"},{name: "Joe",  pfp: "../static/media/examplePfp.png"}],
      tasks: [{ name: "BLAH", description: "Desc1", assignee: {name: "Daniel",  pfp: "../static/media/examplePfp.png"}, hours: 5.0, status: 1},{ name: "Task2", description: "Desc2", assignee: {name: "Joe",  pfp: "../static/media/examplePfp.png"}, hours: 2.0, status: 2}],
